    ...
    <nav class="bg-white border-gray-200 border-b dark:bg-gray-900">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            <a href="/" class="flex items-center">
                <img src="https://ts3.tc.mm.bing.net/th/id/OIP-C.-YGfB_ZhxoUuMwX4r2Zh3QHaHf?rs=1&pid=ImgDetMain&o=7&rm=3" class="h-8 mr-3 rounded-xl" alt="Flowbite Logo" />
                <span class="self-center text-2xl font-black whitespace-nowrap dark:text-white">czltnb</span>
            </a>
